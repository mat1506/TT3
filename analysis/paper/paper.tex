...
(\textasciitilde2.8 m) of the profile exponsed on the western wall from
the new geoarchaeological excavation Tagua-Tagua 3 (Figure 1a and 1b).
The cores were transported to the IACT-CSIC (Granada) and IPE-CSIC
(Zaragoza-Jaca) laboratories in Spain for image acquisition and
measurement of sediment physical properties, density and Magnetic
Susceptibility (MS {[}x10\(^{-8}\) \((m^3/kg)\){]})
